<style>
    ...
    .swiper-custom-arrow-btn.active {
        border-color: transparent;
        opacity: 1;
        color: var(--nft-white);
        background: var(--nft-btn-gradient-color);
    }
                ...
                <div id="about" class="about">
                    ...
                    @foreach ($experiences as $experience)
                        <div class="about-item">
                            <div class="about-btn ">
                                <button class="about-arrow swiper-custom-arrow-btn top-artwork-next-button transparent-gradiant-hover-btn transition-03-linear  z-1 position-relative d-flex justify-content-center align-items-center rounded-circle bg-transparent {{ $index < 2 ? 'active' : '' }}"
                                    type="button" id="item{{ $index + 1 }}" aria-labelledby="item{{ $index + 1 }}-name" aria-expanded="{{ $index < 2 ? 'true' : 'false' }}" aria-controls="item{{ $index + 1 }}-ctrld" aria-haspopup="true" data-item="{{ $index + 1 }}">
                            ...
                            <div class="about-body {{ $index < 2 ? 'about-body-expanded' : '' }}" id="item{{ $index + 1 }}-ctrld" role="region" aria-labelledby="item{{ $index + 1 }}" aria-hidden="{{ $index < 3 ? 'false' : 'true' }}">
