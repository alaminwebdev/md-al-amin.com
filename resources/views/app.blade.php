                    ...
                    <nav class="navbar">
                        <ul data-in="#" data-out="#" class="menu" id="menu-main-menu">
                            <li id="menu-item-1850" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-13 current_page_item menu-item-1850 active">
                                <a title="Home" href="https://wpriverthemes.com/gridx/">Home</a>
                            </li>
                            <li id="menu-item-1851" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1851"><a title="About" href="https://wpriverthemes.com/gridx/about-page/">About</a></li>
                            <li id="menu-item-1853" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1853"><a title="Works" href="https://wpriverthemes.com/gridx/work/">Works</a></li>
                            <li id="menu-item-1852" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1852"><a title="Contact" href="https://wpriverthemes.com/gridx/contact-info/">Contact</a>
                            </li>
                        </ul>
                    </nav>
                    <a href="https://wpriverthemes.com/gridx/contact-info" class="theme-btn">Let s talk</a>
            ...
            <div class="container">
                <div class="footer-content text-center">
                    ...
                    <ul data-in="#" data-out="#" class="footer-menu" id="menu-footer-menu">
                        ...
                        <li id="menu-item-1857" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1857"><a title="About" href="https://wpriverthemes.com/gridx/about-page/">About</a></li>
                        <li id="menu-item-1859" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1859"><a title="Works" href="https://wpriverthemes.com/gridx/work/">Works</a></li>
                        <li id="menu-item-1858" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1858"><a title="Contact" href="https://wpriverthemes.com/gridx/contact-info/">Contact</a></li>
                    </ul>
                    <p class="copyright">
